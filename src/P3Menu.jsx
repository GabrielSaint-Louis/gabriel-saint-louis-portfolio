...
export default function P3Menu({ onNavigate }) {
  ...
  useEffect(() => {
    const onKey = (e) => {
      ...
      if (e.key === "Enter")     { playClickSound(); onNavigate?.(ITEMS[active].page); }
    };
  ...
  return (
    <>
      <style>{`
        ...
        .p3-stripe  { position:absolute; right:0; top:0; bottom:0; width:5px; background:#db3400; z-index:10; pointer-events:none; }
        .p3-stripe2 { position:absolute; right:9px; top:0; bottom:0; width:2px; background:rgba(242,118,56,0.22); z-index:10; pointer-events:none; }
        ...
        .p3-glow {
          ...
          background: radial-gradient(ellipse at center, rgba(242,118,56,0.35) 0%, transparent 70%);
          filter: blur(18px);
          z-index: 0;
          pointer-events: none;
          opacity: 0;
        ...
        .p3-row.active .p3-label-dark { color: #3d0a00; }
        .p3-row:hover:not(.active) .p3-label-dark { color: #f27638; }
        ...
        @media (max-width: 1280px) {
          .p3-menu { transform: scale(0.88); transform-origin: right center; }
        }
        @media (max-width: 1024px) {
          .p3-menu { transform: scale(0.72); transform-origin: right center; }
        }
        @media (max-width: 768px) {
          .p3-menu { transform: scale(0.55); transform-origin: right center; padding: 32px 80px 32px 32px; }
          .p3-name-tag { top: 7vw; left: 11vw; }
          .p3-name-tag span { font-size: 6.5vw; }
          .p3-hint { bottom: 10px; right: 12px; }
          .p3-hint-row { font-size: 11px; }
        }
        @media (max-width: 480px) {
          .p3-menu { transform: scale(0.42); transform-origin: right center; padding: 16px 50px 16px 16px; }
          .p3-name-tag { top: 9vw; left: 12vw; }
          .p3-name-tag span { font-size: 8vw; }
        }
          ...
          {ITEMS.map((item, i) => {
            ...
            return (
              <a
                ...
                onClick={(e) => { e.preventDefault(); playClickSound(); onNavigate?.(item.page); }}
